...
export default function page() {
  return (
    <div className=" flex flex-col mx-auto h-screen bg-background-light dark:bg-background-dark">
      ...
      <main id="content">
        <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 dark:text-neutral-400">We'll Update It Soon</p>
      ...
      <footer className="mt-auto text-center py-5">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8"></div>
      </footer>
    </div>
  );
}
