...
function Footer() {
  return (
    <Section type="paddingXY" id="footer" className="relative pt-10 bg-background">
      <div className="flex flex-col items-start justify-between w-full lg:flex-row">
        <GridList className="grid-cols-1 md:gap-10 gap-5 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2">
          ...
          <div className="flex flex-col flex-wrap col-span-1 gap-1">
            ...
            <div>
              <NormalLink path="/services/software">Our Team</NormalLink>
            </div>
            <div>{/* <NormalLink path="/about/our-team">Our Team</NormalLink> */}</div>
            <div>
              <NormalLink path="/about/career">Career</NormalLink>
            </div>
          </div>
          <div className="flex flex-col flex-wrap  col-span-1 gap-1 md:col-span-1">
            <h1 className="text-business text-[24px] font-Satoshi font-medium pb-3">
              Contact Us
            </h1>
            <div>
            ...
            <div>{/* <NormalLink path="/our-clients">Clients</NormalLink> */}</div>
            {/* <div>
    ...
    //           fill="currentColor"
    //           viewBox="0 0 16 16">
    //           <path d="M3.362 10.11c0 .926-.756 1.681-1.681 1.681S0 11.036 0 10.111C0 9.186.756 8.43 1.68 8.43h1.682v1.68zm.846 0c0-.924.756-1.68 1.681-1.68s1.681.756 1.681 1.68v4.21c0 .924-.756 1.68-1.68 1.68a1.685 1.685 0 0 1-1.682-1.68v-4.21zM5.89 3.362c-.926 0-1.682-.756-1.682-1.681S4.964 0 5.89 0s1.68.756 1.68 1.68v1.682H5.89zm0 .846c.924 0 1.68.756 1.68 1.681S6.813 7.57 5.889 7.57H1.681C.756 7.57 0 6.813 0 5.889a1.685 1.685 0 0 1 1.68-1.682h4.21zm10.11 5.9c0 .926-.756 1.681-1.681 1.681s-1.681-.756-1.681-1.68V8.429h1.681c.925 0 1.681.756 1.681 1.681zm-.846 0c0-.924-.756-1.68-1.68-1.68s-1.681.756-1.681 1.68v4.21c0 .924.756 1.68 1.68 1.68a1.685 1.685 0 0 0 1.682-1.68v-4.21zm-3.681-5.9c.926 0 1.681-.756 1.681-1.681S12.5 0 11.575 0 9.894.756 9.894 1.68v1.682h1.681zm0 .846c-.924 0-1.68.756-1.68 1.681s.756 1.681 1.68 1.681h4.208c.926 0 1.682-.756 1.682-1.681a1.685 1.685 0 0 0-1.681-1.682h-4.21zm-2.526 4.254a.845.845 0 1 0-1.69 0 .845.845 0 0 0 1.69 0z" />
    //         </svg>
    //       </a>
    //     </div>
    //   </div>
