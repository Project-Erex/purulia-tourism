  ...
  return (
    <div className="w-full h-full grid grid-cols-1 md:grid-cols-3  max-w-7xl mx-auto gap-4 relative">
      ...
      <motion.div
        ...
        className={cn(
          "absolute h-full w-full left-0 top-0 bg-background dark:bg-background-dark z-10 cursor-pointer",
  ...
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-end rounded-lg shadow-2xl relative z-[60]">
      ...
      <motion.div
        ...
        <div>
          <p className="font-bold text-4xl text-white my-4">{selected.content}</p>
        </div>
      </motion.div>
    </div>
  );
