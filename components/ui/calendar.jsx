  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 border-2 p-5 rounded-xl",
        ...
        head_row: "flex",
        head_cell:
          "text-slate-500 rounded-md w-16 font-normal text-[0.8rem] dark:text-slate-400",
        row: "flex w-full mt-2",
        cell: "h-16 w-16 text-center text-sm p-0 m-2 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-slate-100/50 [&:has([aria-selected])]:bg-slate-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-slate-800/50 dark:[&:has([aria-selected])]:bg-slate-800",
        day: cn(
